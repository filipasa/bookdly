...
?>
<script>
    var workflow_twilio_whatsapp_action_all_shortcodes = <?php echo json_encode($parameters['body_shortcodes']) ?>;

    var workflow_twilio_whatsapp_action_all_shortcodes_obj = {};

    workflow_twilio_whatsapp_action_all_shortcodes.forEach((value,index)=>{
        workflow_twilio_whatsapp_action_all_shortcodes_obj[value.code] = value.name;
    });
</script>
...
<script type="text/javascript" src="<?php echo TwilioWhatsappAddon::loadAsset('assets/backend/js/workflow_action_edit.js')?>"></script>
