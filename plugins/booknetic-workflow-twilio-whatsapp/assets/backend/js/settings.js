(function ($)
{
	...
	$(document).ready(function()
	{
		...
		$('#booknetic_settings_area').on('click', '.settings-save-btn', function ()
		{
			...
			data.append('whatsapp_account_sid', sms_account_sid);
			data.append('whatsapp_auth_token', sms_auth_token);
			data.append('sender_phone_number_whatsapp', sender_phone_number_whatsapp);

			booknetic.ajax('twilio_whatsapp.save_settings', data, function()
			{
