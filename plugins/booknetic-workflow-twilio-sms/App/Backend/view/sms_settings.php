...
<div id="booknetic_settings_area">
	<script type="application/javascript" src="<?php echo TwilioSMSAddon::loadAsset('assets/backend/js/settings.js')?>"></script>
	...
	<div class="settings-light-portlet">
		<div class="ms-title">
			<?php echo bkntc__('SMS Twilio settings')?>
		</div>
		<div class="ms-content">
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="input_sender_phone_number"><?php echo bkntc__('Sender phone number for SMS')?>:</label>
