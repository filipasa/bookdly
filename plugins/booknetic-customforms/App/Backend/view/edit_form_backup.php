	...
	<div class="col-xl-3 col-md-6 col-lg-5 p-3 pr-md-1 pr-xl-3 pl-xl-1">
		<div class="fs_portlet">
			...
			<div id="formbuilder_options" class="fs_portlet_content">
				...
				<div class="form-row hidden" data-for="label,text,textarea,number,date,time,select,checkbox,radio,file,link,email,phone">
				...
				<div class="form-row hidden" data-for="text,textarea,number,date,time,file,select,email,phone">
					<div class="form-group col-md-12">
				...
				<div class="form-row hidden" data-for="text,textarea,number,date,time,select,checkbox,radio,file,email,phone">
					<div class="form-group col-md-12">
