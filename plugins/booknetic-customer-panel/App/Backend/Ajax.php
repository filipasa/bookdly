...
class Ajax extends \BookneticApp\Providers\Core\Controller
{
    ...
    public function save_customer_panel_settings()
    {
        ...
        $customer_panel_allow_cancel		                    = Helper::_post('customer_panel_allow_cancel', 'off', 'string', ['on', 'off']);
    ...
    public function save_customer_panel_settings_saas()
    {
        ...
        Helper::setOption('customer_panel_allow_reschedule', $customer_panel_allow_reschedule, false);
        Helper::setOption('customer_panel_allow_cancel', $customer_panel_allow_cancel, false);
        Helper::setOption('customer_panel_allowed_status', $customer_panel_allowed_status, false);
        Helper::setOption('time_restriction_to_make_changes_on_appointments', $time_restriction_to_make_changes_on_appointments, false);
        Helper::setOption('customer_panel_reschedule_allowed_status', $customer_panel_reschedule_allowed_status, false);
