...
<div id="booknetic_settings_area">
	...
	<script type="application/javascript" src="<?php echo CustomerPanelAddon::loadAsset('assets/backend/js/customer_panel_settings.js') . '?v=' . time(); ?>"></script>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div class="form-control-checkbox">
                                ...
                                <div class="fs_onoffswitch">
                                    <input type="checkbox" class="fs_onoffswitch-checkbox" id="input_customer_panel_allow_cancel"<?php echo Helper::getOption('customer_panel_allow_cancel', 'off')=='on'?' checked':''?>>
