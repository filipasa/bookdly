...
class Config
{
    ...
    public static function registerCoreTenantCapabilities(): void
    {
        ...
        Capabilities::registerTenantCapability('location_categories', bkntc__('Location Categories module'), 'locations');
        Capabilities::registerTenantCapability('customer_categories', bkntc__('Customer Categories module'), 'customers');
        Capabilities::registerTenantCapability('service_categories', bkntc__('Service Categories module'), 'services');
    }
    ...
    public static function registerCoreRoutes(): void
    {
        ...
        if (Capabilities::tenantCan('services')) {
            ...
            if (Capabilities::tenantCan('service_categories')) {
    ...
    public static function registerCoreMenus(): void
    {
        ...
        if (Capabilities::tenantCan('services') && Capabilities::userCan('services')) {
            ...
            if (Capabilities::tenantCan('service_categories') && Capabilities::userCan('service_categories')) {
                MenuUI::get('services')
