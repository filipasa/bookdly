(function ($)
{
    ...
    $(document).ready(function()
    {
        $('.fs-modal').on('click', '#eventSettingsSave', function ()
        {
            ...
            var location_categories = $("#input_location_categories").val();
            ...
            data.append('location_categories', JSON.stringify( location_categories ));
        ...
        booknetic.select2Ajax( $(".fs-modal #input_location_categories"), 'workflow_events.get_location_categories');
