( function ( $ ) {
    ...
    $( document ).ready( function () {
        $( '.fs-modal' ).on( 'click', '#saveWorkflowActionBtn', function () {
            ...
            booknetic.ajax( 'workflow_actions.mobile_app_notification_save', data, function () {
        ...
        booknetic.initKeywordsInput( $( '#input_title' ), workflow_mobile_app_notification_action_all_shortcodes_obj );
        booknetic.summernote(
            ...
            workflow_mobile_app_notification_action_all_shortcodes_obj
        );
    } );
})(jQuery);