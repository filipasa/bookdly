...
<style>
/* Reset and override Booknetic defaults for this modal body only */
.fs-modal-body {
    padding: 0 !important;
}
.fs-modal-body-inner {
...
/* Hide multi-lang globe icon */
#addServiceForm .multilang_globe_icon {
...
<div class="wf-category-modal-body">
    <form id="addServiceForm">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" data-multilang="true" data-multilang-fk="<?php echo $parameters->getServiceCategory()->getId() ?>" value="<?php echo htmlspecialchars($parameters->getServiceCategory()->getName()) ?>" id="new_category_name" placeholder="<?php echo bkntc__('e.g. Nail Care')?>">
        </div>
    </form>
</div>
...
<script>
(function($) {
    var modal = $('#add_new_JS').closest('.fs-modal');
    modal.find('.fs-modal-title, .fs-modal-footer').hide();
})(jQuery);
</script>
