...
use BookneticApp\Backend\Services\Services\ServiceCatalogService;
...
class ServiceRestController
{
    ...
    public function __construct(ServiceCatalogService $service, ServiceCategoryService $categoryService)
    {
