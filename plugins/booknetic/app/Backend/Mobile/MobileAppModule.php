...
use BookneticApp\Backend\Mobile\Controllers\MobileAppViewAjaxController;
...
class MobileAppModule implements IModule
{
    ...
    public static function registerRoutes(): void
    {
        ...
        Container::addBulk([
            ...
            MobileAppViewAjaxController::class,
        ...
        Route::post('mobile_app_view', Container::get(MobileAppViewAjaxController::class));
    ...
    public static function registerPermissions(): void
    {
        ...
        Capabilities::register('mobile_app_save_settings', bkntc__('Mobile app settings'), 'mobile_app');
