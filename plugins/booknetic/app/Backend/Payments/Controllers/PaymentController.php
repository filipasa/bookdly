...
class PaymentController extends Controller
{
    ...
    public function index(): void
    {
        ...
        $dataTable->addColumns(bkntc__('STATUS'), fn ($appointment) => $this->renderStatus($appointment), ['is_html' => true, 'order_by_field' => 'payment_status']);
    ...
    public function renderStatus($appointment): string
    {
