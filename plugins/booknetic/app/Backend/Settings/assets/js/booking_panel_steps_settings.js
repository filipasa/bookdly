	...
	$(document).ready(function ()
	{
        ...
        bookneticSettings.setOnSave(function () {
            var hide_address_of_location = $("#input_hide_address_of_location").is(':checked') ? 'on' : 'off',
                ...
                require_email_confirmation = $("#require_email_confirmation").is(':checked') ? 'on' : 'off',
                ...
                hide_location_accordion_default = $("#input_hide_location_accordion_default").is(':checked') ? 'on' : 'off',
                show_service_search = $("#input_show_service_search").is(':checked') ? 'on' : 'off',
            ...
            booknetic.ajax('save_booking_steps_settings', {
                ...
                hide_location_accordion_default: hide_location_accordion_default,
                show_service_search: show_service_search,
                ...
                translations: booknetic.getTranslationData($('#step-settings')),
		...
		$('#step-settings').on('click', '.step_element:not(.selected_step)', function ()
		{
