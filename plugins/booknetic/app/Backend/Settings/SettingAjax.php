...
class SettingAjax extends \BookneticApp\Providers\Core\Controller
{
    ...
    public function calendar_settings()
    {
        ...
        $enableCustomCalendarCardContent = Helper::getOption('use_custom_calendar_card_content', false);
        ...
        return $this->modalView('calendar_settings', [
            ...
            "enableCustomCalendarCardContent" => $enableCustomCalendarCardContent
        ]);
    }
    ...
    public function save_advanced_settings()
    {
        ...
        $timePriority     = Post::string('time_priority', 'staff', ['staff', 'service', 'merge']);
    ...
    public function save_calendar_settings()
    {
        ...
        $appointmentCardColor = Post::string('appointmentCardColor', 'eventColor');
        $eventContent = Post::string('eventContent');
        $enableCustomCalendarCardContent = Post::boolString('enableCustomCalendarCardContent');

        Helper::setOption('calendar_event_color', $appointmentCardColor);
        Helper::setOption('calendar_event_content', $eventContent);
        Helper::setOption('use_custom_calendar_card_content', $enableCustomCalendarCardContent);
    ...
    public function save_booking_steps_settings()
    {
        ...
        $require_email_confirmation         = Helper::_post('require_email_confirmation', 'off', 'string', [ 'on', 'off' ]);
        ...
        $hide_location_accordion_default    = Helper::_post('hide_location_accordion_default', 'off', 'string', [ 'on', 'off' ]);
        $show_service_search                = Helper::_post('show_service_search', 'off', 'string', [ 'on', 'off' ]);
        ...
        Helper::setOption('require_email_confirmation', $require_email_confirmation);
        ...
        Helper::setOption('hide_location_accordion_default', $hide_location_accordion_default);
        Helper::setOption('show_service_search', $show_service_search);
        ...
        $this->translationService->saveOptions($translations, [ 'redirect_url_after_booking' ]);
    ...
    public function save_payment_gateways_settings()
    {
        ...
        if (! empty($translations)) {
            $this->translationService->saveOptions($translations, [ 'woocommerce_order_details' ]);
        }
    ...
    public function save_company_settings()
    {
        ...
        $this->translationService->saveOptions($translations, [ 'company_name', 'company_address' ]);
