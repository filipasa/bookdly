...
$requireEmailConfirmation = Helper::getOption('require_email_confirmation', 'off');
...
<div id="step-settings" class="step_settings_container">
    ...
    <div class="step_elements_options dashed-border">
        <form id="booking_panel_settings_per_step" class="position-relative">
            ...
            <div class="hidden" data-step="location">
                ...
                <div class="form-group col-md-12">
                    <div class="form-control-checkbox">
                        <label for="input_hide_location_accordion_default"><?php echo bkntc__('Collapse Locations under a Category')?>:</label>
                        <div class="fs_onoffswitch">
                            <input type="checkbox" class="fs_onoffswitch-checkbox" id="input_hide_location_accordion_default"<?php echo Helper::getOption('hide_location_accordion_default', 'off') == 'on' ? ' checked' : ''?>>
                            <label class="fs_onoffswitch-label" for="input_hide_location_accordion_default"></label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="hidden" data-step="service">
                ...
                <div class="form-group col-md-12">
                    <div class="form-control-checkbox">
                        <label for="input_show_service_search"><?php echo bkntc__('Show search on Service step')?>:</label>
                        <div class="fs_onoffswitch">
                            <input type="checkbox" class="fs_onoffswitch-checkbox" id="input_show_service_search"<?php echo Helper::getOption('show_service_search', 'off') == 'on' ? ' checked' : ''?>>
                            <label class="fs_onoffswitch-label" for="input_show_service_search"></label>
                        </div>
                    </div>
                </div>
            </div>
...
foreach ($parameters['months'] as $month):  ?>
            ...
            <div class="hidden" data-step="information">
                ...
                <div class="form-group col-md-12">
                    <div class="form-control-checkbox">
                        <label for="require_email_confirmation"><?php echo bkntc__('Require email confirmation')?>:</label>
                        <div class="fs_onoffswitch">
                            <input type="checkbox" class="fs_onoffswitch-checkbox" id="require_email_confirmation"<?php echo $requireEmailConfirmation == 'on' ? ' checked' : ''?>>
                            <label class="fs_onoffswitch-label" for="require_email_confirmation"></label>
                        </div>
                    </div>
                </div>
