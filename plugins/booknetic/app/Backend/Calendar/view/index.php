...
<script src="<?php echo Helper::assets('js/introjs.min.js') ?>"></script>

<?php do_action('bkntc_module_calendar_loaded'); ?>
<script>
    var customStatuses = <?php echo json_encode($parameters['statuses']); ?>;
</script>
<script src="<?php echo Helper::assets('js/onboarding.js', 'Calendar') ?>"></script>
...
<div class="m_header ">
	...
	<div class="m_head_actions flex-column flex-md-row">
        ...
        <div class="d-flex align-items-center">
            <div class="create_new_appointment mr-2">
            ...
            <div class="create_new_busy_slot">
                <div class="create_new_busy_slot_btn action_btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                        <path d="M12 5V19M5 12H19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span><?php echo \bkntc__('Add Busy Slot') ?></span>
                </div>
            </div>
        </div>
	</div>
