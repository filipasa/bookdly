...
$localization = [
    ...
    // Dashboard
    'Show All'    => bkntc__('Show All'),
    'Show Active' => bkntc__('Show Active'),
    'Show More'   => bkntc__('Show More'),
    'Day-based'   => bkntc__('Day-based'),

    "TODAY'S APPOINTMENTS"      => bkntc__("TODAY'S APPOINTMENTS", [], false),
    "YESTERDAY'S APPOINTMENTS"  => bkntc__("YESTERDAY'S APPOINTMENTS", [], false),
    "TOMORROW'S APPOINTMENTS"   => bkntc__("TOMORROW'S APPOINTMENTS", [], false),
    "THIS WEEK'S APPOINTMENTS"  => bkntc__("THIS WEEK'S APPOINTMENTS", [], false),
    "LAST WEEK'S APPOINTMENTS"  => bkntc__("LAST WEEK'S APPOINTMENTS", [], false),
    "THIS MONTH'S APPOINTMENTS" => bkntc__("THIS MONTH'S APPOINTMENTS", [], false),
    "THIS YEAR'S APPOINTMENTS"  => bkntc__("THIS YEAR'S APPOINTMENTS", [], false),
    'APPOINTMENTS'              => bkntc__('APPOINTMENTS'),

    'No appointments scheduled for today'    => bkntc__('No appointments scheduled for today'),
    'No appointments found for yesterday'    => bkntc__('No appointments found for yesterday'),
    'No appointments scheduled for tomorrow' => bkntc__('No appointments scheduled for tomorrow'),
    'No appointments found for this week'    => bkntc__('No appointments found for this week'),
    'No appointments found for last week'    => bkntc__('No appointments found for last week'),
    'No appointments found for this month'   => bkntc__('No appointments found for this month'),
    'No appointments found for this year'    => bkntc__('No appointments found for this year'),
    'No appointments found for this period'  => bkntc__('No appointments found for this period'),
];
...
<div class="left_side_menu">
    ...
    <ul class="l_m_nav">
        ...
        <div class="left_side_menu_footer d-none d-md-block">
            <div class="sidebar_divider"></div>
            <a href="#" class="collapse_menu_btn">
                <svg class="collapse_sidebar_icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="3" y="4" width="18" height="16" rx="3" stroke="currentColor" stroke-width="2" fill="none"/>
                    <path d="M9 4V20" stroke="currentColor" stroke-width="2"/>
                    <path d="M6 4H9V20H6C4.34315 20 3 18.6569 3 17V7C3 5.34315 4.34315 4 6 4Z" fill="currentColor"/>
                </svg>
                <span class="collapse_menu_text">Collapse menu</span>
            </a>
        </div>
    </div>
...
<div class="top_side_menu">
    <div class="t_m_left">
        <?php if (Helper::isSaaSVersion() && Permission::isAdministrator()): ?>
            <button class="btn btn-default btn-lg d-lg-inline-block d-none share_your_page_btn" type="button">
        ...
        <?php foreach (MenuUI::getItems(AbstractMenuUI::MENU_TYPE_TOP_LEFT) as $menu): ?>
            <a class="btn btn-default btn-lg d-lg-inline-block d-none" href="<?php echo $menu->getLink(); ?>"><i class="<?php echo $menu->getIcon(); ?> pr-2"></i>
                <span><?php echo $menu->getTitle(); ?></span>
            </a>
        <?php endforeach; ?>

        <button class="btn btn-default btn-lg d-lg-none" type="button" id="open_menu_bar"><i class="fa fa-bars"></i>
        </button>
    </div>
    <div class="t_m_right">
            ...
            <div class="modal-body password-generate-modal">
                ...
                <div class="d-flex align-items-center justify-content seat-credentials-container">
                    ...
                    <div class="qr-code-container">
                        <div class="qr-loading"><i class="fa fa-spinner fa-spin"></i></div>
                        <img class="credentials-qr-code" src="" alt="<?php echo bkntc__('QR Code') ?>" style="display: none;">
                        <p class="p-0 mb-2"><?php echo bkntc__('Scan to login') ?></p>
                    </div>
                </div>
            </div>
        ...
        <?php if (!Helper::isSaaSVersion() && Capabilities::userCan('mobile_app')):?>
...
<script>
    jQuery(document).ready(function($) {
        $(document).on('click', '.collapse_menu_btn', function(e) {
            e.preventDefault();
            var $sidebar = $('.left_side_menu');
        ...
        if (localStorage.getItem('sidebar_collapsed') === '1') {
            $('.left_side_menu').addClass('sidebar_collapsed');
        }
    });
</script>
</body>
