(function ($) {
    ...
    booknetic.priceAndNumberFormatter = {
        ...
        toLocaleValue: function (value) {
            const format = this.numberFormats[price_settings.price_number_format] || this.numberFormats.default;
            return String(value).replace('.', format.decimalPoint);
        },
        ...
        formatInput: function (input, inputType) {
            ...
            let numericValue = newValue.replace(decimalPoint, '.');
