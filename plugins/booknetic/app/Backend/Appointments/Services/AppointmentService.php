...
class AppointmentService
{
     ...
     */
    public function getServices(string $search = ''): array
    {
        $rows = $this->appointmentRepository->searchServices($search);

        return $this->selectOptionMapper->toResponse(
            $rows,
     ...
     * @return SelectOptionResponse[]
     */
    public function getStaff(string $search = ''): array
    {
        $rows = $this->appointmentRepository->searchStaff($search);
    ...
    {
        $rows = $this->appointmentRepository->searchCustomers($search);
     ...
     * @return SelectOptionResponse[]
     */
    public function getLocations(string $search = ''): array
    {
        $rows = $this->appointmentRepository->searchLocations($search);
    ...
    public function getFilters(string $search = ''): array
    {
        ...
        foreach ($filters as $id => $label) {
            ...
            $result[] = new SelectOptionResponse(
                $id,
                $label
            );
        }
