...
function customerTpl($display = false, $customerId = 0, $customerName = '')
{
        ...
        <div class="col-md-6">
            <div class="input-group">
                <select class="form-control input_customer">
                    <?php if ($customerId > 0): ?>
                        <option value="<?php echo $customerId; ?>" selected><?php echo htmlspecialchars($customerName); ?></option>
                    <?php endif; ?>
                </select>
...
<div class="form-row">
    <div class="form-group col-md-12">
        ...
        <div class="customers_area">
            <?php
            $customerId = isset($parameters['customer_id']) ? (int)$parameters['customer_id'] : 0;
            $customerName = '';
            if ($customerId > 0) {
                $custObj = \BookneticApp\Models\Customer::get($customerId);
                if ($custObj) {
                    $customerName = $custObj->first_name . ' ' . $custObj->last_name;
                }
            }
            echo customerTpl(true, $customerId, $customerName);
            ?>
        </div>
    </div>
</div>
