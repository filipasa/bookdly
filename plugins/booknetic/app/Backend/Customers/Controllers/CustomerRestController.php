...
class CustomerRestController
{
     ...
     */
    public function deleteAll(RestRequest $request): array
    {
    ...
    public function delete(RestRequest $request): array
    {
        ...
        $this->service->delete($id, $deleteWpUser);
    ...
    {
        $id = $request->param('id', 0, RestRequest::TYPE_INTEGER);
        $requestData = $this->prepareSaveRequestRestDTO($request, $id, true);
     ...
     * @throws Exception
     */
    private function prepareSaveRequestRestDTO(RestRequest $request, int $id = 0, bool $isEdit = false): CustomerRequest
    {
        $wpUser = $request->param('wp_user', 0, RestRequest::TYPE_INTEGER);
        $firstName = $request->require('first_name', RestRequest::TYPE_STRING, bkntc__('First Name field must be provided'));
        ...
        $email = $request->require('email', RestRequest::TYPE_EMAIL, bkntc__('Email field must be provided'));
