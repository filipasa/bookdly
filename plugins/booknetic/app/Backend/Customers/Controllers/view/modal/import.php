					...
					<div class="form-row">
						<div class="form-group col-md-12">
                            <div class="mb-1 d-flex">
                                <input checked type="checkbox" id="defaultCheck1" name="fields[]" value="category">
                                <label class="pl-2" for="defaultCheck1"><?php echo bkntc__('Category')?></label>
                            </div>
                            <div class="mb-1 d-flex">
                                <input checked type="checkbox" id="defaultCheck2" name="fields[]" value="first_name">
                                <label class="pl-2" for="defaultCheck2"><?php echo bkntc__('First Name')?></label>
                            </div>
							<div class="mb-1 d-flex">
								<input checked type="checkbox" id="defaultCheck3" name="fields[]" value="last_name">
								<label class="pl-2" for="defaultCheck3"><?php echo bkntc__('Last Name')?></label>
							</div>
							<div class="mb-1 d-flex">
								<input checked type="checkbox" id="defaultCheck4" name="fields[]" value="email">
								<label class="pl-2" for="defaultCheck4"><?php echo bkntc__('Email')?></label>
							</div>
							<div class="mb-1 d-flex">
								<input checked type="checkbox" id="defaultCheck5" name="fields[]" value="phone_number">
								<label class="pl-2" for="defaultCheck5"><?php echo bkntc__('Phone')?></label>
							</div>
							<div class="mb-1 d-flex">
								<input checked type="checkbox" id="defaultCheck6" name="fields[]" value="gender">
								<label class="pl-2" for="defaultCheck6"><?php echo bkntc__('Gender')?></label>
							</div>
							<div class="mb-1 d-flex">
								<input checked type="checkbox" id="defaultCheck7" name="fields[]" value="birthdate">
								<label class="pl-2" for="defaultCheck7"><?php echo bkntc__('Date of birth')?></label>
							</div>
							<div class="mb-1 d-flex">
								<input checked type="checkbox" id="defaultCheck8" name="fields[]" value="notes">
								<label class="pl-2" for="defaultCheck8"><?php echo bkntc__('Note')?></label>
							</div>
						</div>
					</div>
