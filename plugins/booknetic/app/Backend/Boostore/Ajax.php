...
class Ajax extends \BookneticApp\Providers\Core\Controller
{
    ...
    public function get_subscription_upgrade_url()
    {
        if (Permission::isDemoVersion()) {
            return $this->response(false, 'This feature is not available in Demo version!');
        }

        $addon = Helper::_post('addon', '', 'string');
        $url = BoostoreHelper::generateSubscriptionUpgradeUrl($addon);
