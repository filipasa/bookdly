...
$subscription = $parameters[ 'subscription' ] ?? null;
$userPlanSlug = is_array($subscription) ? ($subscription[ 'planSlug' ] ?? null) : null;
?>
            ...
            <div class="addons_card">
                <div class="addons_card_content">
                        ...
                        <div class="card_stats d-flex justify-content-space-between mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <?php endif; ?>
                                 ...
                                 <?php if ($addon[ 'released' ] && $userPlanSlug === null): ?>
                    ...
                    <div class="card_btns mt-3">
                        <?php
                        $addonPlans = is_array($addon[ 'plans' ] ?? null) ? $addon[ 'plans' ] : [];
        $isIncludedInPlan = $userPlanSlug !== null && in_array($userPlanSlug, $addonPlans, true);
        ?>
                        <?php if ($addon[ 'purchase_status' ] === 'unowned'): ?>
                            <?php if ($userPlanSlug !== null): ?>
                                <?php if ($isIncludedInPlan): ?>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <button class="btn btn-warning btn-lg btn-upgrade" data-addon="<?php echo htmlspecialchars($addon[ 'slug' ]); ?>">
                                        <i class="fa fa-crown mr-2"></i>
                                        <?php echo bkntc__('UPGRADE'); ?>
                                    </button>
                                <?php endif; ?>
                            <?php elseif ($addon[ 'in_cart' ]): ?>
...
?>
        ...
        <a href="<?php echo htmlspecialchars('http://bookdly.co.uk/'); ?>" class="need_help_btn"
