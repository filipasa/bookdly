(function ($)
{
	...
	$(document).ready(function()
	{
		...
		}).on('click', '#addStaffSave', function ()
		{
            ...
            const staffId = $(".fs-modal #add_new_JS").data('staff-id');
            const phoneNumber = $phoneInput.data('iti').getNumber(bookneticIntlTelInput.utils.numberFormat.E164);
			...
			booknetic.ajax( 'staff.save', data, function()
			{
		...
		{
			booknetic.ajax('hide', { staff_id: $(".fs-modal #add_new_JS").data('staff-id') }, function ()
			{
				booknetic.modalHide($(".fs-modal"));
