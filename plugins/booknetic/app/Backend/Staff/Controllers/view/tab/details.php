...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        <input type="text" data-multilang-fk="<?php echo $parameters->getId() ?>" class="form-control" id="input_name" value="<?php echo htmlspecialchars($parameters->getStaff()->getName())?>">
    </div>

    <div class="form-group col-md-6">
        <label for="input_name"><?php echo bkntc__('Profession')?></label>
        <input type="text" data-multilang-fk="<?php echo $parameters->getId() ?>" class="form-control" id="input_profession" value="<?php echo htmlspecialchars($parameters->getStaff()->getProfession())?>">
    </div>
</div>
