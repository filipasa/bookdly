...
<button
        ...
        data-location-category="<?php echo (isset($parameters['location_category']) && is_numeric($parameters['location_category'])) ? htmlspecialchars($parameters['location_category']) : ''; ?>"
