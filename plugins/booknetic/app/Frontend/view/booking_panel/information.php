...
$showEmailConfirmInput = ! empty($parameters['show_email_confirm_input']);

$identifier = $parameters['customer_identifier'];
?>

<div class="booknetic-login-buttons-container">
    <?php if ($parameters['show_google_login_button']): ?>
        <button class="gsi-material-button booknetic_social_login_google" data-href="<?php echo $parameters['google_login_button_url']?>">
            ...
            <span class="gsi-material-button-content-wrapper">
                <span class="gsi-material-button-icon">
                    <img src="<?php print Helper::assets('icons/google.svg', 'front-end')?>" alt="<?php echo bkntc__('Google icon')?>">
                </span>
                <span class="gsi-material-button-contents"><?php echo bkntc__('Continue with Google')?></span>
            </span>
        </button>
    <?php endif; ?>

    <?php if ($parameters['show_facebook_login_button']): ?>
        <button type="button" class="gsi-material-button gsi-material-button--facebook booknetic_social_login_facebook" data-href="<?php echo $parameters['facebook_login_button_url']?>">
            <span class="gsi-material-button-state"></span>
            <span class="gsi-material-button-content-wrapper">
                <span class="gsi-material-button-icon">
                    <img src="<?php print Helper::assets('icons/facebook.svg', 'front-end')?>" alt="<?php echo bkntc__('Facebook icon')?>">
                </span>
                <span class="gsi-material-button-contents"><?php echo bkntc__('Continue with Facebook')?></span>
            </span>
        </button>
    <?php endif; ?>
</div>
...
<?php if ($showEmailConfirmInput): ?>
    <div class="form-row">
        <div class="form-group col-md-6" data-bkntc-customer-info="true">
            <label for="bkntc_input_email_confirm"<?php echo $parameters['email_is_required'] == 'on' ? ' data-required="true"' : ''?>><?php echo bkntc__('Confirm email')?></label>
            <input type="text" id="bkntc_input_email_confirm" class="form-control" name="email_confirm" value="">
        </div>
    </div>
<?php endif; ?>
