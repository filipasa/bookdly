    ...
    <div class="booknetic_confirm_date_time booknetic_portlet <?php echo $parameters['hide_confirm_step'] ? 'booknetic_hidden' : ''?>">
        ...
        <?php if (Helper::getOption('show_step_staff', 'on') != 'off'): ?>
            <div>
               ...
               <span class="booknetic_confirm_staff_span">
                    <img class="booknetic_confirm_staff_image" src="<?php echo Helper::profileImage($parameters['appointmentData']->staffInf->profile_image, 'Staff') ?>" style="width: 24px; height: 24px; border-radius: 50%; object-fit: cover; vertical-align: middle; margin-right: 8px;">
