...
<div class="booknetic_appointment<?php echo Helper::isRTLLanguage(Permission::tenantId()) ? " rtl" : "" ?>" id="booknetic_theme_<?php echo $themeId;?>" data-info="<?php echo $info ?>" data-steps="<?php print htmlspecialchars(json_encode($stepsArr))?>" data-tenant-id="<?php echo Permission::tenantId() ?? ''; ?>">
    ...
    <div class="booknetic_appointment_container">
        ...
        <div class="booknetic_appointment_container_footer">
            ...
            <?php else: ?>
                <div class="booknetic_warning_message" style="display: block !important; color: #EF4444 !important; font-weight: 600 !important;"><?php echo bkntc__('Booking is currently disabled. Please contact the administrator to renew the plan.')?></div>
            <?php endif; ?>
        </div>
