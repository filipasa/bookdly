...
class Frontend
{
    ...
    private static function registerWpShortcodes(): void
    {
    ...
    private static function checkSocialLogin(): void
    {
    ...
    public static function initAjaxRequests($class = false): void
    {
