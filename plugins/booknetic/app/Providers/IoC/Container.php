...
class Container
{
    ...
    public static function bind(string $interface, $concrete): void
    {
        self::getInstance()->aliases[$interface] = $concrete;
    }
    ...
    public static function has(string $id): bool
    {
        ...
        return isset($instance->services[$id]) || isset($instance->aliases[$id]);
    }
    ...
    public static function get(string $id)
    {
        ...
        // Resolve alias (interface → concrete)
        if (isset($instance->aliases[$id])) {
            $alias = $instance->aliases[$id];
