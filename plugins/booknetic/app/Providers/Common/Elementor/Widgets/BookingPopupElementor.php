...
class BookingPopupElementor extends Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        $bookneticData = [
            ...
            'location_categories' => LocationCategory::select(['id', 'name'])->fetchAll()
        ];
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Location category filter', 'booknetic-popup'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'options' => $this->props['location_categories'],
            ]
        );
    ...
    private function getShortCodeContent($settings)
    {
        $this->atts = [
            ...
            'location_category' => $settings['location_category_filter'],
