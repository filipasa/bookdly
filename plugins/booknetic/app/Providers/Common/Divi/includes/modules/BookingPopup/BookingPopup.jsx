...
function buildShortcode(props)
{
  ...
  let list = ['staff','category','service','location','location_category','theme','class','caption','style'];
...
function Bpanel(props){
  ...
  },[props.staff,props.location,props.location_category,props.service,props.theme,props.category,props.caption,props.class,props.style])
