...
class WorkflowEventFilterData
{
    ...
    private array $locationCategories = [];
    ...
    public static function fromArray(?array $data): self
    {
        ...
        $instance->locationCategories = is_array($data['location_categories'] ?? null) ? $data['location_categories'] : [];
    ...
    public function hasLocationCategories(): bool
    {
        return count($this->locationCategories) > 0;
    }

    public function matchesLocationCategory(int $locationCategoryId): bool
    {
        return in_array($locationCategoryId, $this->locationCategories);
    }
}
