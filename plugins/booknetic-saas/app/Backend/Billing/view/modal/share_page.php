	...
	<div class="fs-modal-body-inner">
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				<label for="input_booking_page_url"><?php echo bkntcsaas__('Your booking page URL')?>:</label>
		...
		<div class="form-row">
			<div class="form-group col-md-12">
				...
				<input type="text" id="input_directory_page_url" readonly class="form-control" value="<?php 
					$page_id = \BookneticApp\Providers\Helpers\Helper::getOption('tenant_directory_page_id');
					$page_path = $page_id ? get_page_uri($page_id) : 'booking-panel';
					$landingPageUrl = site_url('/' . $page_path . '/');
					echo esc_url(add_query_arg('bkntc_page_id', Permission::tenantId(), $landingPageUrl));
				?>">
			</div>
		</div>
