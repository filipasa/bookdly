...
class Ajax extends \BookneticApp\Providers\Core\Controller
{
    ...
    public function save_plan()
    {
        ...
        $order_by				        = Helper::_post('order_by', 0, 'int');
        $is_active				        = Helper::_post('is_active', 'on', 'string', ['on', 'off']);
        $description			        = Helper::_post('description', '', 'string');
        $monthly_price			        = Helper::_post('monthly_price', 0, 'float');
        $monthly_price_discount         = Helper::_post('monthly_price_discount', 0, 'int');
        $annually_price			        = Helper::_post('annually_price', 0, 'float');
        $annually_price_discount        = Helper::_post('annually_price_discount', 0, 'int');
