...
<link rel="stylesheet" href="<?php echo StripeAddon::loadAsset('assets/backend/css/connect_settings_saas.css' )?>">
<script type="application/javascript" src="<?php echo StripeAddon::loadAsset('assets/backend/js/connected_tenants_saas.js')?>"></script>
        ...
        <div class="card connected_tenants_body">
            ...
            <ul class="list-group list-group-flush">
                ...
                <?php foreach( $parameters[ 'tenants' ] AS $key => $tenant ): ?>
                    <li class="list-group-item" data-tenant-id="<?php echo $key ?>" data-account-id="<?php echo $tenant['stripe_connect_account_id'] ?>">
